    ...
    return (
        <section ref={containerRef} id="brands" className="py-16 bg-white border-b border-gray-100 overflow-hidden">
            <div className="container mx-auto px-6 mb-10 text-center">
                <h2 className="font-heading text-2xl md:text-3xl font-bold">BRANDS WE <span className="text-primary">SERVE</span></h2>
                <p className="font-sans text-muted-foreground text-sm mt-2">Specialized care for all premium and luxury manufacturers</p>
            </div>
