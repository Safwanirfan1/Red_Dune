                    ...
                    <div className="flex flex-col lg:flex-row items-stretch gap-0 min-h-[580px]">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 leading-[1.7] max-w-xl mb-10">
                                Precision computerized wheel alignment to improve driving stability, tire life, and fuel efficiency on UAE roads.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 space-y-8" data-aos="fade-right" data-aos-duration="800">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 leading-[1.7]">
                                    We use advanced computerized alignment machines that precisely measure and correct camber, caster, and toe angles to manufacturer specifications. Our technicians inspect every suspension angle and steering component to deliver lasting results — not just a quick fix.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-2">
                                {["Certified technicians", "Precision calibration", "Transparent service", "Fast turnaround"].map(
                                    (item, i) => (
                                        <div
                                            key={i}
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                        ...
                        <div className="w-full lg:w-1/2 space-y-8" data-aos="fade-left" data-aos-duration="800">
                            <div>
                                ...
                                <div className="w-12 h-[3px] bg-primary mb-6" />
                                <p className="text-lg text-gray-600 leading-[1.7]">
                                    UAE road conditions — including speed breakers, potholes, and extreme desert heat that expands road surfaces — place additional stress on your vehicle&apos;s suspension and alignment. We recommend checking alignment more frequently than in temperate climates.
                                </p>
                            </div>
            ...
            <section className="py-[100px] bg-white border-b border-gray-100 overflow-hidden">
                <div className="container mx-auto max-w-[1200px] px-6">
                    ...
                    <div className="text-center max-w-2xl mx-auto space-y-8" data-aos="fade-up" data-aos-delay="200">
                        <p className="text-lg text-gray-600 leading-[1.7]">
                            If you experience any of these symptoms, have your alignment checked immediately. Driving with incorrect alignment causes accelerated tire wear, poor fuel consumption, and puts unnecessary strain on steering and suspension components.
                        </p>
                        <Link href="#contact" className="inline-block w-full sm:w-auto">
            ...
            <section className="py-[100px] bg-black text-white" id="contact">
                <div className="container mx-auto max-w-[1200px] px-6 text-center">
                    ...
                    <p
                        ...
                        data-aos-delay="100"
                    >
                        Ensure smooth driving, better control, and longer tire life with professional wheel alignment service performed using modern computerized equipment.
                    </p>
